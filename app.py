...
model = pickle.load(open(r'C:\Users\Suyash\PycharmProjects\pythonProject\Mushroom_Classification\Model\rfPickle.pkl', 'rb'))
...
def predict():
    if request.method == 'POST':
        try:
            ...
            x = pd.DataFrame({"gill_color": [gillcolor], "spore_print_color": [sporeprintcolor],
                              "population": [population], "gill_size": [gillsize], "stalk_root": [stalk_root],
                              "bruises": [bruises], "stalk_shape": [stalkshape]})
